  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className={cn(
          "fixed inset-y-0 left-0 z-50 h-screen border-r border-border bg-background flex flex-col justify-between transition-transform duration-300 md:relative md:translate-x-0",
          isMobileMenuOpen ? "translate-x-0" : "-translate-x-full"
        )}
      >
        <div className="flex-1 overflow-hidden flex flex-col">
          {/* Brand header */}
          <div className="h-auto flex items-center justify-between px-6 py-4 border-b border-border shrink-0">
            ...
            <button
              ...
              className="absolute -right-6 top-6 w-10 h-10 rounded-full bg-background text-foreground flex items-center justify-center border border-border shadow-sm hover:bg-muted transition-colors z-50"
            >
